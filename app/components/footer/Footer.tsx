    ...
    <footer>
      <nav className="footer__nav">
        <ul className="footer__nav-list">
          <li className={`footer__nav-list-link ${location.pathname === "/chat" ? "footer__active" : ""}`}>
            <Link to="/chat">
              <svg
                width="48px"
                height="48px"
          ...
          <li className={`footer__nav-list-link ${location.pathname === "/home" ? "footer__active" : ""}`}>
            <Link to="/home">
              <svg
                fill="#000000"
                height="48px"
          ...
          <li className={`footer__nav-list-link ${location.pathname === "/profil" ? "footer__active" : ""}`}>
            <Link to="/profil">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48px"
