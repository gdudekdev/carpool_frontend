import IconProfilAttestation from "~/src/assets/icon/profil/IconProfilAttestation";
import IconProfilBlock from "~/src/assets/icon/profil/IconProfilBlock";
import IconProfilCgu from "~/src/assets/icon/profil/IconProfilCgu";
import IconProfilCookies from "~/src/assets/icon/profil/IconProfilCookies";
import IconProfilFaq from "~/src/assets/icon/profil/IconProfilAttestation";
import IconProfilHistorique from "~/src/assets/icon/profil/IconProfilHistorique";
